...
function removeResume() {
    ...
    document.querySelector('#removeResumee').parentElement.remove();
...
function addEducationalBackground(){
    ...
    document.querySelector('.educational-background').innerHTML  +=
    `<div class="inputs">
...
function removeEducationalBackground() {
    
    document.querySelector('#removeEducationalBackgroundd').parentElement.remove();
...
function removelanguage() {
    ...
    document.querySelector('#removelanguagee').parentElement.remove();
...
function addFamiliarityWithSpecializedSoftware(){
    ...
    document.querySelector('.familiarity-with-specialized-software').innerHTML  +=
    `<div class="inputs">
...
function removeFamiliarityWithSpecializedSoftware() {
    document.querySelector('#removeFamiliarityWithSpecializedSoftwaree').parentElement.remove();
}
...
function addSpecializedCoursesProvided(){
    ...
    document.querySelector('.specialized-courses-provided').innerHTML  +=
    `<div class="inputs">
...
function removeSpecializedCoursesProvided() {
    
    document.querySelector('#removeSpecializedCoursesProvidedd').parentElement.remove();
